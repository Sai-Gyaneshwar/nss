          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="update.php">
                ...
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="Name" name="Name" placeholder="Enter your subject of query">
                    <label for="Name">Subject</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
                    <textarea class="form-control" placeholder="Enter content" id="floatingTextarea" style="height: 100px;"></textarea>
