            ...
            <div class="card-body">
              ...
              <div class="row justify-content-between">
                  <div class="col-sm-3">
                    <button type="button" class="btn btn-warning mb-2">
                      Update Tax <span class="badge bg-white text-warning">4</span>
                    </button>
                  </div>
              ...
              <div class="row">
                <div class="col text-center">
                  <p>Sending Bills To User (16/68)</p>
                  ...
                  <form action="" method="post">
                    <input type="submit" class="btn btn-primary center" value="Send Tax" data-bs-toggle="modal" data-bs-target="#modalDialogScrollable">
                  </form>
